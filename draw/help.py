...
def draw_help_image():
    ...
    y0 = draw_section("⚡ 基础命令", basic, y0, cols=2)
    y0 = draw_section("⚔️ 游戏玩法", gameplay, y0, cols=2)
    y0 = draw_section("🎮 核心特色", game_features, y0, cols=2)
    ...
    guide_text = [
        ...
        "2. 通过 /三国签到 积累你的初始资本。",
        "3. 使用 /三国招募 获得强大的武将伙伴。",
        "4. 准备好后，就用 /三国闯关 开启你的传奇冒险吧！",
        "5. 在冒险中，你的选择至关重要，请谨慎决定。",
        "",
        "💡 提示：高声望可以解锁特殊事件，带来更好的奖励！",
